...
osrdose <- function(stress, tspan){
  if(1){
    pars.nostim = c(
      ...
      buildNrf2Base = 2.297422e+02, #2.297422e base, test1 = 2.297422e+01, test2 = 2.297422e+01
      vMax = 1.345040e+08, #vMax = 1.345040e+08 base, test1 = 1.345040e+06, test2 = 1.345040e+05
      km = 3.816342e+02,
      kiRM = 1.338881e-06,
...
xx <- osrdose(stress = 4, tspan) #test1 = 1, test2 = 1 
...
Nrf2 %>% write.table(.,"E:/BFW/Master BPS/RP1/Neural Network/R - OSR model/Nrf2_test2.txt")
Srxn1 %>% write.table(.,"E:/BFW/Master BPS/RP1/Neural Network/R - OSR model/Srxn1_test2.txt")
