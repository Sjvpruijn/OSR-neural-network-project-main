...
osrdose <- function(stress, tspan){
  if(1){
    pars.nostim = c(
      ...
      buildNrf2Base = 3.297422e+03, #2.297422e+02 base, training = e02, test1 = 6.297422e+02, test2 = 2.297422e+02
      vMax = 1.345040e+08, #vMax = 1.345040e+08 base/training, test1 = 1.345040e+04, test2 = 1.345040e+06
      km = 3.816342e+02, 
      kiRM = 1.338881e-06,
      buildGshBase = 5.530482e-02,
      buildGsh = 1.063481e+03, #00
...
xx <- osrdose(stress = 4, tspan) #training = 1-4 to test1 = 1, test2 = 1 
...
Nrf2 %>% write.table(.,"E:/BFW/Master BPS/RP1/Neural Network/R - OSR model/Training set 4/Nrf2_training1.txt")
Srxn1 %>% write.table(.,"E:/BFW/Master BPS/RP1/Neural Network/R - OSR model/Training set 4/Srxn1_training1.txt")
