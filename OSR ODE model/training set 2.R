...
osrdose <- function(stress, tspan){
  if(1){
    pars.nostim = c(
      ...
      vMax = 1.345040e+06, #base = 1.345040e+08, test1 = 1.345040e+05 test2 = 1.345040e+06
      km = 3.816342e+02,
      kiRM = 1.338881e-06,
      ...
      degradSrxn1 = 3.687709e-02, #base = 3.687709e-08, training = 3.687709e-02
...
xx <- osrdose(stress = 1, tspan) #train = 3, 3.25, 3.5, 3.75, 4 test1 = 3 test2 = 1
...
Nrf2 %>% write.table(.,"E:/BFW/Master BPS/RP1/Neural Network/R - OSR model/Training set 2/Nrf2_test2.txt")
Srxn1 %>% write.table(.,"E:/BFW/Master BPS/RP1/Neural Network/R - OSR model/Training set 2/Srxn1_test2.txt")
