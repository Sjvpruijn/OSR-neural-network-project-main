...
osrdose <- function(stress, tspan){
  if(1){
    pars.nostim = c(
      ...
      vMax = 1.345040e+05, #Training = 1.345040e+08 , test1 = 1.345040e+06, test2 = 1.345040e+05
      km = 3.816342e+02,
      kiRM = 1.338881e-06,
...
xx <- osrdose(stress = 1, tspan) #test1 = 1, test2 = 1, training = 1,2,3,4
...
Nrf2 %>% write.table(.,"C:/.../OSE ODE model/Nrf2_test2.txt")
Srxn1 %>% write.table(.,"C:/.../OSE ODE model/Srxn1_test2.txt")
