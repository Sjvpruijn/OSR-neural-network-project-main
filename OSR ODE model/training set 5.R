...
osrdose <- function(stress, tspan){
  if(1){
    pars.nostim = c(
      ...
      buildNrf2Base = 2.297422e+04, #training = 02, test1 = 02, test2 = 02, test3 = 01 test4 = 04
      vMax = 1.345040e+01, #training = 08, test1 = 07, test2 = 06 test3 = 07 test4 = 04
      km = 3.816342e+02,
      kiRM = 1.338881e-06, #training = -06
      ...
      degradSrxn1 = 3.687709e-02, #training = -02 
      degradRM = 9.137437e-02,#base = -02
...
xx <- osrdose(stress = 1, tspan) #1-4 test1 = 1, test2 = 1
...
Nrf2 %>% write.table(.,"E:/BFW/Master BPS/RP1/Neural Network/R - OSR model/Training set 5/Nrf2_test4.txt")
Srxn1 %>% write.table(.,"E:/BFW/Master BPS/RP1/Neural Network/R - OSR model/Training set 5/Srxn1_test4.txt")
