...
osr <- function(t, inistate, parameters) {
  with(as.list(c(inistate, parameters)), {
    ...
    dS = -time_constant1 * S
    dNrf2 = exportNrf2 * nNrf2 - importNrf2 * Nrf2 + buildNrf2Base/(Nrf2*maxNrf2k) - (vMax * Nrf2) / (km * (1 + RM / kiRM) + Nrf2)
...
osrdose <- function(stress, tspan){
  if(1){
    pars.nostim = c(
      ...
      buildNrf2Base = 2.297422e+02, #2.297422e+02 base, training = e1-4, test1 = 6.297422e+02, test2 = 2.297422e+02, test3 = 2.297422e+02, test4 = 2.297422e+02
      vMax = 1.345040e+07, #vMax = 1.345040e+04 base, test1 = 1.345040e+04, test2 = 1.345040e+05, test3 = 1.345040e+06, test4 = 1.345040e+07
      km = 3.816342e+02, 
      kiRM = 1.338881e-06,
...
xx <- osrdose(stress = 1, tspan) #training = 1 to test1 = 1, test2 = 1 
...
Nrf2 %>% write.table(.,"E:/BFW/Master BPS/RP1/Neural Network/R - OSR model/Training set 4/Nrf2_test4.txt")
Srxn1 %>% write.table(.,"E:/BFW/Master BPS/RP1/Neural Network/R - OSR model/Training set 4/Srxn1_test4.txt")
